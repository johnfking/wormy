...
'S877':	['Drifter - Sentinel',	    750000000,	300000000, 0, 0, 16],
'T405':	['Class 4 W-Space',	    2000000000,	300000000, 0, 4, 16],
'T458':	['Thera',	            500000000,	20000000, 0, 0, 16],
...
'V898':	['Lowsec',	            2000000000,	300000000, 0, 0, 16],
...
bot.on('ready', () => {
  bot.setActivity('the thug SLYCE life!', { type: 'PLAYING' });
